        ...
        <section class="boring-legal">
          <address class="clickable-container">
            <AliasLink
              newTab
              classes={['external']}
              url="https://x.com/cvewhen"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 2px;">
            ...
            <AliasLink
              newTab
              classes={['external']}
              url="https://linkedin.com/in/debxrshi"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 2px;">
        ...
        >
          <div class="site-wave-bg" aria-hidden="true">
            <svg class="site-wave-svg" viewBox="0 0 1600 1000" preserveAspectRatio="xMidYMid slice">
              <defs>
                <linearGradient id="site-wave-ribbon-body-fill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" style="stop-color: var(--gray); stop-opacity: 0.04" />
                  <stop offset="30%" style="stop-color: var(--darkgray); stop-opacity: 0.1" />
                  <stop offset="68%" style="stop-color: var(--darkgray); stop-opacity: 0.28" />
                  <stop offset="100%" style="stop-color: var(--gray); stop-opacity: 0.08" />
                </linearGradient>
                <linearGradient id="site-wave-ribbon-highlight-fill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" style="stop-color: var(--light); stop-opacity: 0.54" />
                  <stop offset="45%" style="stop-color: var(--lightgray); stop-opacity: 0.2" />
                  <stop offset="100%" style="stop-color: var(--light); stop-opacity: 0" />
                </linearGradient>
                <linearGradient id="site-wave-ribbon-shadow-fill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" style="stop-color: var(--darkgray); stop-opacity: 0" />
                  <stop offset="100%" style="stop-color: var(--dark); stop-opacity: 0.24" />
                </linearGradient>
                <pattern
                  id="site-wave-grain-fill"
                  x="0"
                  y="0"
                  width="42"
                  height="24"
                ...
                >
                  <ellipse cx="4" cy="5" rx="1.6" ry="0.6" style="fill: var(--light); fill-opacity: 0.1" />
                  <ellipse cx="14" cy="8" rx="2.2" ry="0.8" style="fill: var(--light); fill-opacity: 0.08" />
                  <ellipse cx="23" cy="4" rx="1.4" ry="0.5" style="fill: var(--light); fill-opacity: 0.09" />
                  <ellipse cx="34" cy="9" rx="2.1" ry="0.7" style="fill: var(--lightgray); fill-opacity: 0.08" />
                  <ellipse cx="9" cy="17" rx="1.9" ry="0.7" style="fill: var(--lightgray); fill-opacity: 0.08" />
                  <ellipse cx="20" cy="15" rx="2.5" ry="0.85" style="fill: var(--light); fill-opacity: 0.09" />
                  <ellipse cx="31" cy="18" rx="1.8" ry="0.65" style="fill: var(--light); fill-opacity: 0.08" />
                  <ellipse cx="39" cy="14" rx="1.3" ry="0.45" style="fill: var(--lightgray); fill-opacity: 0.08" />
                </pattern>
                <symbol id="site-wave-ribbon" viewBox="-320 0 2560 180">
                  <path
                    fill="url(#site-wave-ribbon-body-fill)"
                    d="M-320 10 C -36 -102, 250 112, 544 10 S 1116 -90, 1408 10 S 1980 118, 2240 14 L 2240 176 C 1968 250, 1702 100, 1408 176 S 824 250, 544 176 S -44 98, -320 176 Z"
                  />
                  <path
                    fill="url(#site-wave-ribbon-highlight-fill)"
                    d="M-320 52 C -32 -22, 250 112, 544 52 S 1116 -10, 1408 52 S 1972 118, 2240 54 L 2240 82 C 1972 132, 1694 68, 1408 82 S 836 134, 544 82 S -36 68, -320 82 Z"
                  />
                  <path
                    fill="url(#site-wave-grain-fill)"
                    d="M-320 44 C -28 -12, 250 98, 544 44 S 1112 -2, 1408 44 S 1976 102, 2240 46 L 2240 110 C 1972 146, 1698 96, 1408 110 S 838 154, 544 110 S -32 96, -320 110 Z"
                    opacity="0.42"
                  />
                  <path
                    fill="url(#site-wave-ribbon-shadow-fill)"
                    d="M-320 106 C -46 42, 242 156, 544 106 S 1102 42, 1408 106 S 1980 158, 2240 106 L 2240 176 C 1968 250, 1702 100, 1408 176 S 824 250, 544 176 S -44 98, -320 176 Z"
                  />
                </symbol>
              </defs>
              <g class="site-wave-plane site-wave-plane--far">
                <g class="site-wave-ribbon-instance site-wave-ribbon-instance--a" transform="translate(-380 110) scale(1.34 1.34)">
                  <use href="#site-wave-ribbon" />
                </g>
                <g class="site-wave-ribbon-instance site-wave-ribbon-instance--b" transform="translate(-470 430) scale(1.2 1.24)">
                  <use href="#site-wave-ribbon" />
                </g>
                <g class="site-wave-ribbon-instance site-wave-ribbon-instance--c" transform="translate(-560 760) scale(1.06 1.12)">
                  <use href="#site-wave-ribbon" />
                </g>
              </g>
              <g class="site-wave-plane site-wave-plane--near">
                <g class="site-wave-ribbon-instance site-wave-ribbon-instance--d" transform="translate(-420 250) scale(1.28 1.42)">
                  <use href="#site-wave-ribbon" />
                </g>
                <g class="site-wave-ribbon-instance site-wave-ribbon-instance--e" transform="translate(-500 620) scale(1.1 1.24)">
                  <use href="#site-wave-ribbon" />
                </g>
              </g>
            </svg>
